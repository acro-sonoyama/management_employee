	...
	<body>
		...
		<div class="content">
			...
			<article>
				...
				<div class="update">
					<form action="?actionId=EmpRegistCheck" method="post">
						<div class="form">
						...
						<div class="form">
							...
							<div class="input">
								<label><input type="radio" name="gender" value="1" <c:if test="${emp.gender != 2}">checked</c:if> />男性&nbsp;</label>
								<label><input type="radio" name="gender" value="2" <c:if test="${emp.gender == 2}">checked</c:if> />女性</label>
							</div>
						</div>
						...
						<div class="form">
							...
							<div class="input">
								<label><input type="radio" name="authority" value="1" <c:if test="${emp.authority != 2}">checked</c:if> />一般&nbsp;</label>
								<label><input type="radio" name="authority" value="2" <c:if test="${emp.authority == 2}">checked</c:if> />管理者</label>
							</div>
						</div>
